   ...
   <div class="content-page">
       <div class="content">
		<div class="page-header-title">
		 ...
		 <div class="page-content-wrapper ">
			...
			<span class="glyphicon glyphicon-plus"></span> Post Job</button>
	<div class="table-responsive">
		...
		<table id="employee_grid" class="table table-bordered table-hover" width="60%" cellspacing="0" data-toggle="bootgrid">
          ...
          <th data-column-id="type">job Type</th>
          <th data-column-id="title">Job Title</th>
          <th data-column-id="company_name">Company Name</th>
          <th data-column-id="company_desc">Company Description</th>
          ...
          <th data-column-id="qualification">Qualification</th>
					<th data-column-id="experience">Experience</th>
          <th data-column-id="shift">Shift</th>
          <th data-column-id="description">Description</th>
          <th data-column-id="skills">Skills</th>
       ...
       <div class="col-md-6">
        ...
        <div class="col-md-12">
                 <div class="form-group">
                    ...
                    <textarea rows="5" name="company_desc" class="form-control" required></textarea>
                  </div>
        </div>
...
<div id="edit_model" class="modal fade">
    <div class="modal-dialog modal-lg zoomIn  animated">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Edit Post Job</h4>
            </div>
            <div class="modal-body">
...
console.log(g_id);
  ...
  $("#user_edit").load("php/job/job_edit.php?id="+idd);       
    ...
    }).end().find(".command-delete").on("click", function(e)
    {
		...
		var conf = confirm('Delete ' + $(this).data("row-id") + ' items?');
					//alert(conf);
                    if(conf){
                                $.post('php/job/job.php', { id: $(this).data("row-id"), action:'delete'}
                                    , function(){

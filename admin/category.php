    ...
    <div class="row">
       <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ctname" required />
                  </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="form-group">
                    ...
                    <input type="file" id="fileupload" class="form-control"  name="photo" required />
                  </div>
         </div>

                <div class="col-lg-6">
                   <div  id="dvPreview">
                    <img class="img img-thumbnail" src="<?php //echo $rows['logo']; ?>">
                   </div>
                </div>
...
console.log(g_id);
  ...
  $("#user_edit").load("php/category/category_edit.php?id="+idd);       
    ...
    var conf = confirm('Delete ' + $(this).data("row-id") + ' items?');
          //alert(conf);
                    if(conf){
                                $.post('php/category/category.php', { id: $(this).data("row-id"), action:'delete'}
                                    , function(){
